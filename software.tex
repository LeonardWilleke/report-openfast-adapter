...
%OpenFAST\footnote{\url{https://openfast.readthedocs.io/en/main/}} is a wind energy engineering tool developed by the National Renewable Energy Laboratory (NREL). It is widely used in academia and industry to simulate the coupled aerodynamic, structural, and electrical behaviour of wind turbines as well as the control response. The tool allows to model on- and offshore wind turbines and can be used to simulate wind parks consisting of multiple turbines as well. 
